...
void StateMachineTypeC(void)
{
        ...
        {        
           ...
           printk("zou_hao:%2x,%2x,%2x,%2x,%2x,%2x,%2x*******\n",Registers.Status.byte[0]&0xff,Registers.Status.byte[1]&0xff,Registers.Status.byte[2],Registers.Status.byte[3]&0xff,Registers.Status.byte[4]&0xff,Registers.Status.byte[5]&0xff,Registers.Status.byte[6]&0xff); 
         printk("******\n");
        }
#ifdef FSC_INTERRUPT_TRIGGERED
