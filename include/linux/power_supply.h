...
enum power_supply_property {
	...
	POWER_SUPPLY_PROP_VBUS_NOW,             //mzy add 20160504
	POWER_SUPPLY_PROP_STANDARD_ADAPTER,     //mzy add 20160505
	POWER_SUPPLY_PROP_MTK_HANDSHAKE,        //mzy add 20160325
	POWER_SUPPLY_PROP_CURRENT_FIT,          //mzy add 20160509
	POWER_SUPPLY_PROP_PM_CONTROL_WAKE,      //mzy add 20160510
	POWER_SUPPLY_PROP_PM_CONTROL_RELAX,     //mzy add 20160510
	POWER_SUPPLY_PROP_IINDPM_STATUS,
#endif
